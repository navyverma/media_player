...
{
    public class NativeHost2 : NativeControlHost
    {
        //static NativeHost2()
        //{
        //    ContentProperty.Changed.AddClassHandler<NativeHost2>((s, e) => s.InitializeNativeOverlay());
        //    IsVisibleProperty.Changed.AddClassHandler<NativeHost2>((s, e) => s.ShowNativeOverlay(s.IsVisible));
        //}

        //public static readonly StyledProperty<object> ContentProperty =
        //    ContentControl.ContentProperty.AddOwner<NativeHost2>();
        ...
        //    _isEffectivellyVisibleSub = null;
